 ...
 *  - $config['rest_keys_table'] = 'mail_api_keys'; (default: 'keys')
 *  - $config['rest_enable_keys'] = TRUE; (default: FALSE)
 *  - $config['rest_logs_table'] = 'mail_api_logs'; (default: 'logs')
 *  - $config['rest_access_table'] = 'mail_api_access'; (default: 'access')
 *  - $config['rest_limits_table'] = 'mail_api_limits'; (default: 'limits')
 *
...
|
*/
$config['rest_keys_table'] = 'mail_api_keys';
...
|
*/
$config['rest_logs_table'] = 'mail_api_logs';
...
|
*/
$config['rest_access_table'] = 'mail_api_access';
...
|
*/
$config['rest_limits_table'] = 'mail_api_limits';
