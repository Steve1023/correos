...
class Panel extends Admin_Controller {
	...
	{
		$crud = $this->generate_crud('mail_admin_users');
		...
		{
			$crud->set_relation_n_n('groups', 'mail_admin_users_groups', 'mail_admin_groups', 'user_id', 'group_id', 'name');
		}
	...
	{
		$crud = $this->generate_crud('mail_admin_groups');
	...
	public function admin_user_reset_password($user_id)
	{
		...
		$this->load->model('admin_user_model', 'mail_admin_users');
		$target = $this->mail_admin_users->get($user_id);
