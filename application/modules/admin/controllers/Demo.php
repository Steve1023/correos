...
class Demo extends Admin_Controller {
	...
	{
		$crud = $this->generate_crud('mail_demo_blog_posts');
		...
		$crud->set_relation('category_id', 'mail_demo_blog_categories', 'title');
	...
	{
		$crud = $this->generate_crud('mail_demo_blog_categories');
		$crud->columns('title');
	...
	{
		$crud = $this->generate_crud('mail_demo_blog_tags');
	...
	{
		$crud = $this->generate_image_crud('mail_demo_cover_photos', 'image_url', UPLOAD_DEMO_COVER_PHOTO);
