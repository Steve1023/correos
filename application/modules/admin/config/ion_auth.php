 ...
 * 	- $config['tables']['users'] = 'mail_admin_users'; (default: 'users')
 * 	- $config['tables']['groups'] = 'mail_admin_groups'; (default: 'groups')
 * 	- $config['tables']['users_groups'] = 'mail_admin_users_groups'; (default: 'users_groups')
 * 	- $config['tables']['login_attempts'] = 'mail_admin_login_attempts'; (default: 'login_attempts')
...
*/
$config['tables']['users']           = 'mail_admin_users';
$config['tables']['groups']          = 'mail_admin_groups';
$config['tables']['users_groups']    = 'mail_admin_users_groups';
$config['tables']['login_attempts']  = 'mail_admin_login_attempts';
