    ...
    'menu' => array(
        ...
        'destinatarios' => array(
            ...
            'children' => array(
                ...
                'Etiquetas' => 'destinatarios/etiquetas',
                'Cargos' => 'destinatarios/des_cargo',
            )
        ),
        'empresas' => array(
            'name' => 'Empresas',
            ...
            'children' => array(
                ...
                'Tipos de empresas' => 'empresas/emp_tipo',
                'Grupos empresariales' => 'empresas/emp_grupo',
            )
        ),
        'remitentes' => array(
            'name' => 'Remitentes',
        ...
        'envios' => array(
            ...
            'icon' => 'ion ion-load-b', // use Ionicons (instead of FontAwesome)
            'children' => array(
                'Nuevo' => 'envios/pendientes/add',
                'Pendientes' => 'envios/pendientes',
                'Remitidos' => 'envios/remitidos',
            )
        ),
        'panel' => array(
            'name' => 'Admin Panel',
