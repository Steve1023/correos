...
class Cli extends MX_Controller {
	...
	// Empty all database tables except "mail_admin_users"
	...
	public function save_default_db()
	{
		...
		$prefs['tables'] = array('mail_admin_groups', 'mail_admin_login_attempts', 'mail_admin_users', 'mail_admin_users_groups');
		$backup = $this->dbutil->backup($prefs);
		...
		// Demo - Cover Photos
		$prefs['tables'] = array('mail_demo_cover_photos');
		$backup = $this->dbutil->backup($prefs);
		...
		// Demo - Blog
		$prefs['tables'] = array('mail_demo_blog_posts', 'mail_demo_blog_categories', 'mail_demo_blog_tags', 'mail_demo_blog_posts_tags');
		$backup = $this->dbutil->backup($prefs);
